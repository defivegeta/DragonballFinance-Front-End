...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, senzuPrice, bnbPrice, ethPrice, btcbPrice2, cake2Price, ethereum, account }) => {
  ...
  const totalValue: BigNumber = useMemo(() => {
    ...
    if (farm.quoteTokenSymbol === QuoteToken.BTCB) {
      return btcbPrice2.times(farm.lpTotalInQuoteToken)
      
    }

    return farm.lpTotalInQuoteToken
  }, [farm.lpTotalInQuoteToken, farm.quoteTokenSymbol, bnbPrice, cakePrice, senzuPrice, cake2Price, ethPrice, btcbPrice2 ])
